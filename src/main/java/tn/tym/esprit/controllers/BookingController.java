...
public class BookingController {
   ...
   SpecialistRepository srp;
    ...
    public ResponseEntity<String> addRDVAndAssignSPCAndCLIENT(@RequestBody Booking booking, @PathVariable Long idSpe, @PathVariable String emailClient, AuthenticationRequest authentication) {
